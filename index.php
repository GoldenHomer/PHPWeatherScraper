...
<head>
  ...
  <link href="http://maxcdn.bootstrapcdn.com/bootstrap/3.1.1/css/bootstrap-theme.min.css">
</head>
  ...
  <div class="container">
  	<div class="row">
		...
		<form>
		  ...
		  <input type="text" class="form-control" name="city" id="city" placeholder="Eg. Lub-bick, Walla Walla, Lizard Lick..." /></div>
